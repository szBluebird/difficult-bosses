...
SHOWCASE_TIME = 0                       -- How long should we show the 'Radiant vs Dire' showcase screen
STRATEGY_TIME = 0                       -- How long should we let people strategize
CUSTOM_GAME_SETUP_REMAINING_TIME = 0    -- Set the amount of remaining time, in seconds, for custom game setup. 0 = finish immediately, -1 = wait forever
...
STARTING_GOLD = 50000                     -- How much starting gold should we give to each player?
